...
def create_user_image_for_admin_user(create_admin_user_with_basic_tier):
    ...
    uploaded_file = SimpleUploadedFile(
        "test_img.jpg", tmp_file.read(), content_type="image/jpg"
    )
...
class TestImagesViewPermissions:
    ...
    def test_images_view_return_images_and_200_for_authenticated_user(
        self, create_authenticated_user_with_basic_tier
    ):
        user, client = create_authenticated_user_with_basic_tier
        url = "list_upload_images"
        response = client.get(reverse(url))
    ...
    def test_if_authenticated_user_post_image_return_201(
        self, create_authenticated_user_with_basic_tier
    ):
        user, client = create_authenticated_user_with_basic_tier
        url = "list_upload_images"
    ...
    def test_images_view_return_images_for_admin_user(
        self, create_admin_user_with_basic_tier
    ):
        user, client = create_admin_user_with_basic_tier
        url = "list_upload_images"
        response = client.get(reverse(url))
    ...
    def test_if_admin_user_post_image_return_201(
        self, create_admin_user_with_basic_tier
    ):
        user, client = create_admin_user_with_basic_tier
        url = "list_upload_images"
...
class TestImageDetailsViewPermissions:
    def test_image_detail_view_return_403_for_anonymous_user(
        self, create_user_image_for_authenticated_user
    ):
    ...
    def test_if_anonymous_user_delete_image_return_403(
        self, create_user_image_for_authenticated_user
    ):
        image_obj = create_user_image_for_authenticated_user
        client = APIClient()
...
class TestImageDetailsViewExpiringLinkPermissions:
    def test_if_anonymous_user_post_expiring_link_time_return_403(
        self, create_user_image_for_authenticated_user
    ):
        image_obj = create_user_image_for_authenticated_user
        client = APIClient()
        url = "image_details"
        data = {"image_link_time": 300}

        response = client.post(
            reverse(url, kwargs={"image_id": image_obj.pk}), data=data, format="json"
        )
        assert response.status_code == status.HTTP_403_FORBIDDEN
    ...
    def test_if_authenticated_user_with_custom_tier_with_no_exp_link_post_image_link_time_return_403(
        self,
        create_authenticated_user_with_basic_tier,
        create_custom_acc_tier_without_exp_link,
        create_user_image_for_authenticated_user,
    ):
        image_obj = create_user_image_for_authenticated_user
        user, client = create_authenticated_user_with_basic_tier
    ...
    def test_if_authenticated_user_with_custom_tier_with_exp_link_post_image_link_time_return_403(
        self,
        create_authenticated_user_with_basic_tier,
        create_custom_acc_tier_with_exp_link,
        create_user_image_for_authenticated_user,
    ):
        image_obj = create_user_image_for_authenticated_user
        user, client = create_authenticated_user_with_basic_tier
    ...
    def test_if_admin_user_with_basic_acc_tier_post_image_link_time_return_403(
        self,
        create_admin_user_with_basic_tier,
