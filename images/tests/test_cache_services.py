...
from images.services.cache_services import (
    store_temporary_link_in_cache,
    get_temporary_link_from_cache,
)
...
def create_user_image(
    create_authenticated_user_with_basic_tier, create_enterprise_acc_tier
):
